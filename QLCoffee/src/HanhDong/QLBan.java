...
public class QLBan {
    ...
    public static KhuVucDao KVDAOAN = new KhuVucDao();
    public static BanAnDao BANDAOAN = new BanAnDao();
    //
                ...
                if (!ban.isTrangThai()) {
                    ...
                    if (Kq == 0) {
                        ...
                        if (chon == JOptionPane.YES_OPTION) {
                            ...
                            QLBan.loadDataToListBan();
                            QLBan.LoadBanToPanel();
                        }
                    } else if (Kq == 1) {
