 ...
 * @author CHIEN
 */
public class TachBanMni extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TachBanMni
     */
    public TachBanMni(HoaDonBH hd, SuKien sk) {
        SK = sk;
        HD = hd;
        initComponents();
        ...
        btBan.addActionListener((ae) -> {
            ...
            if (lbTenBan.getText().length() == 0) {
                ...
                if (!ban.isTrangThai()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Bạn hãy chọn bàn không người ngồi để chuyển");
                }
            }
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if (lbTenBan.getText().length() == 0) {
            JOptionPane.showMessageDialog(this, "Bạn hãy chọn bàn để tách");
        } else {
            Ban bn = getBanBH();
            if (!bn.isTrangThai()) {
                //code tách
                KhuVuc kv = (KhuVuc) comboMode.getElementAt(cbxKhuVuc.getSelectedIndex());
                ChiaCTHoaDonMni chiaHD = new ChiaCTHoaDonMni(HD.getMaHD(), SK,kv,getBanBH());
                chiaHD.setVisible(true);
                this.dispose();
                dispose();
            } else {
...
//            java.util.logging.Logger.getLogger(TachBanMni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new TachBanMni().setVisible(true);
//            }
//        });
//    }
