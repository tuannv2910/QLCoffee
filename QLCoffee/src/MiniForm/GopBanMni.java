 ...
 * @author CHIEN
 */
public class GopBanMni extends javax.swing.JFrame {

    BanHangDao BHDao = new BanHangDao();
    HoaDonBHDao HDDao = new HoaDonBHDao();
    CTHoaDonBHDao CTDHDao = new CTHoaDonBHDao();
    ...
    /**
     * Creates new form GopBanMni
     */
    public GopBanMni(HoaDonBH hoaDon, SuKien suKien, Ban banGop) {
        HoaDon = hoaDon;
        SuKien = suKien;
        BanGop = banGop;
    ...
    public JButton taoBan(Ban ban) {
        ...
        btBan.addActionListener((ae) -> {
            ...
            if (lbTenBan.getText().length() == 0) {
                JOptionPane.showMessageDialog(this, "Bạn hãy chọn bàn gộp lại");
            } else {
                if (!ban.isTrangThai()) {
                    JOptionPane.showMessageDialog(this, "Bạn hãy chọn bàn đã có người ngồi để thực hiện việc gộp");
                } else {
                    ///code gộp bàn
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        // TODO add your handling code here:
        if (lbTenBan.getText().length() == 0) {
            JOptionPane.showMessageDialog(this, "Bạn hãy chọn bàn để gộp đến");
        } else {
            Ban bn = getBanBH();
            if (!bn.isTrangThai()) {
                //code gộp bàn
                JOptionPane.showMessageDialog(this, "Bạn hãy chọn bàn có người ngồi để gộp bàn");

            } else {
                taoHoaDonTamThoi();
                addCTHoaDonMoi();
                updateTrangThaiBan(bn.getMaBan());
                deleteCTHoaDonCu(HoaDon.getMaHD(), HDDao.getHoaDon(bn.getMaBan()).getMaHD());
...
//delete hóa đơn cũ
    ...
    public void deleteCTHoaDonCu(String MaHDGop, String MaHDChuyen) {
        CTDHDao.deleteCTHoaDonCuGop(MaHDGop, MaHDChuyen);
        HDDao.deleteHoaDonTamThoi(MaHDGop);
        HDDao.deleteHoaDonTamThoi(MaHDChuyen);
    }
    //insert ct hóa đơn mới vào bàn gộp

    public void addCTHoaDonMoi() {
        ...
        //
        CTDHDao.loadCTHoaDonGop(HanhDong.MaHD, HoaDon.getMaHD(), hoaDonChon.getMaHD());
    }
//tạo hóa đơn tạm thời
    ...
    public void taoHoaDonTamThoi() {
        ...
        //lấy mã bàn
        HDTamThoi.setMaBan(BanGop.getMaBan());
        //lấy tên bàn
        HDTamThoi.setTenBan(BanGop.getTenBan());
        //lấy tên tài khoản
    ...
    public void updateTrangThaiBan(Integer maBanGopVao) {
        BHDao.updateTrangThaiNgoiTheoMa(0, maBanGopVao);
    }
...
//            java.util.logging.Logger.getLogger(GopBanMni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
