...
public class QLKhuVuc extends javax.swing.JPanel {
    ...
    KhuVucDao KVDAOAN = new KhuVucDao();
    BanAnDao BANDAOAN = new BanAnDao();
    ...
    public void khoiTaoComponent() {
        QLBan.cbxKhuVuc = this.cbxKhuVuc;
        QLBan.pnBanQL = this.pnBanQL;
        QLBan.lbTenBan = this.lbTenBan;
        QLBan.comBoMode = this.comBoMode;
        QLBan.btnThemBan = this.btnThemBan;
        QLBan.btnThemKV = this.btnThemKV;
        QLBan.btnXoaKV = this.btnXoaKV;
    }
