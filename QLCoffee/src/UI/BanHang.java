...
//            lbThanhToan.setText(String.valueOf(hoaDonChon.getTongTienThanhToan()));
    ...
    private void initComponents() {
        ...
        tblBanHang.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, "aaaa",  new Integer(2), "aaaa", "aaaa",  new Boolean(false)},
        ...
        pnMonAn.setMaximumSize(new java.awt.Dimension(1280, 640));
        pnMonAn.setMinimumSize(new java.awt.Dimension(1280, 640));
        pnMonAn.setPreferredSize(new java.awt.Dimension(1280, 640));
